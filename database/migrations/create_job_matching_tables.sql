...
('job.delete', '删除职位', 'job'),
('job.apply', '申请职位', 'job'),
('job.matching', '职位匹配', 'job'),
('job.matching.admin', '职位匹配管理', 'job');
...
-- 记录迁移完成
INSERT INTO `migration_logs` (`migration_name`, `version`, `applied_at`, `description`) VALUES
('create_job_matching_tables', '1.0.0', NOW(), '创建职位匹配系统相关数据表');
