...
require (
	...
	github.com/xiajason/zervi-basic/basic/backend/pkg/cluster v0.0.0-00010101000000-000000000000
...
// 使用本地的cluster包
replace github.com/xiajason/zervi-basic/basic/backend/pkg/cluster => ./pkg/cluster
