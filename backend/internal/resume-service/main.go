...
func main() {
	...
	// 注册到Consul
	registerToConsul("resume-service", "127.0.0.1", 7532)

	// 启动服务
	log.Println("Starting Resume Service with jobfirst-core on 0.0.0.0:7532")
...
func initMySQLDatabase() error {
	// MySQL连接配置
	dsn := "root:@tcp(localhost:3306)/jobfirst?charset=utf8mb4&parseTime=True&loc=Local"
